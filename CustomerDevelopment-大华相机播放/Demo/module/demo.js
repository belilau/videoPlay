...
function clickStartRecord(){
	WebVideoCtrl.startRecordingVideo(0,"LiveRecord",{
			cbSuccess:function(path){
				showOPInfo("录像成功" + "存储位置:" + path);
			},
			cbFailed:function(status,error){
				showOPInfo("录像失败！！！");
			}
		}
	);
...
function clickStartRecord(){
	...
	if(WebVideoCtrl.controlRecordingVideo(path,0,true)){
...
function clickStopRecord(){                
	if(WebVideoCtrl.controlRecordingVideo("",0,false)){
		showOPInfo("关闭录像成功。");
	}else{
		showOPInfo("关闭录像失败！！！");
	}
...
function mouseUPLeftPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		//云台向左上移动
		WebVideoCtrl.moveUpperLeft(deviceID,channel,speed,speed,flag);
...
function mouseUpPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveUpwards(deviceID,channel,speed,flag);
...
function mouseUPRightPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveUpperRight(deviceID,channel,speed,speed,flag);
...
function mouseLefPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveLeft(deviceID,channel,speed,flag);
...
function mouseRightPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveRight(deviceID,channel,speed,flag);
...
function mouseDownLeftPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveLowerLeft(deviceID,channel,speed,speed,flag);
...
function mouseDownRightPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveLowerRight(deviceID,channel,speed,speed,flag);
...
function mouseDownPTZControl(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.moveLower(deviceID,channel,speed,flag);
		
	}
}

function openPtzLocate(){
	if(WebVideoCtrl.activePTZLocate(true)){
		//隐藏开启按钮
		$("#openPtzLocate").hide();
		//显示关闭按钮
		$("#closePtzLocate").show();
...
function closePtzLocate(){
	WebVideoCtrl.activePTZLocate(false);
	$("#closePtzLocate").hide();
	$("#openPtzLocate").show();
}
...
function PTZZoomout(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.controlZoom(deviceID,channel,speed,1,flag);
...
function PTZZoomIn(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.controlZoom(deviceID,channel,speed,0,flag);
...
function PTZFocusIn(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.controlFocus(deviceID,channel,speed,0,flag);
...
function PTZFoucusOut(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.controlFocus(deviceID,channel,speed,1,flag);
...
function PTZIrisIn(flag){
	...
	if(typeof player == "undefined")
	{
		...
		var speed = parseInt($("#ptzspeed").val(), 10)
		//云台向左上移动
		WebVideoCtrl.controlAperture(deviceID,channel,speed,0,flag);
